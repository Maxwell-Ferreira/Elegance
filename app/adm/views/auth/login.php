...
<body class="text-center" style="background-color: #151515">
<div class="container">
    <form class="form-signin text-white" method="post" action="">
        <img class="mb-4" src="<?= URL;?>assets/img/logo/logoteste.png" alt="" width="200">
        ...
        <input type="text" class="form-control" name="user" id="iUser" value="<?= $user; ?>"
               placeholder="Digite seu usuário" required autofocus style="margin-bottom: 2px">
        <label for="iSenha" class="sr-only">Senha:</label>
        <input type="password" class="form-control" name="senha" id="iSenha"
               placeholder="Digite sua senha" required>
        <button id="botao" class="btn btn-lg btn-block" name="sendLogin" type="submit">Logar</button>
