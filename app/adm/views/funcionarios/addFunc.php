                ...
                <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <select name="servicoFunc" class="form-control">
                                ...
                                <?php 
                                    foreach($this->dados['listServico'] as $servicos){
                                        echo "<option value='".$servicos['idServico']."'>".$servicos['descServico']."</option>";
                                    }
                                ?>
                            </select>
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-4" style="text-align: center;">
                            <img src="<?php echo URL.'assets/img/funcionarios/padrao.png'?>" alt="Imagem do Funcionaio" id="preview-user" class="img-thumbnail" style="width: 150px; height: 150px">
                        </div>
                    </div>
                    <p>
