...
<div class="content p-1">
    <div class="list-group-item">
        ...
        <form method="POST" action="" enctype="multipart/form-data"> 
            <input name="idAdm" type="hidden" value="<?php
            if (isset($valorForm['idAdm'])) {
                echo $valorForm['idAdm'];
            }
            ?>">
            <div class="form-row">
            ...
            <div class="form-row">
                <div class="form-group col-md-6">
                    ...
                    <input name="loginAdm" type="text" class="form-control" placeholder="Seu melhor usuario" value="<?php
            ...
            <div class="form-row">
                <div class="form-group col-md-3">
                    ...
                    <input name="senhaAdm" type="password" class="form-control" id="nome" placeholder="Senha com mínimo 6 caracteres" value="">
                </div>
                <div class="form-group col-md-3">
            ...
            <input name="editAdm" type="submit" class="btn btn-warning" value="Salvar">
        </form>
    </div>
</div>
