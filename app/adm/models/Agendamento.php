...
class Agendamento{
    ...
    public function listarAgendamentos(){
        ...
        $listarFunc->exeReadEspecifico("SELECT a.*, f.nomeFunc, s.descServico, c.nomeCliente, h.horario
                                            FROM atendimento a INNER JOIN horario h
                                                    ON a.horario = h.idHorario 
                                                INNER JOIN funcionario f
                                                    ON h.funcHorario = f.idFunc
                                                INNER JOIN servico s
                                                    ON f.servicoFunc = s.idServico
                                                INNER JOIN cliente c
                                                    ON a.cliente = c.idCliente
                                            ORDER BY a.data DESC, h.horarioReal ASC");
