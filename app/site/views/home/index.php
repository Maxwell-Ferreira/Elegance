...
<div style="text-align: center; margin-top: 30px; margin-left: 25%; margin-right: 25%">
    <div  style="display: inline;">
        <p class="text-white">Mussum Ipsum, cacilds vidis litro abertis. Tá deprimidis, eu conheço uma cachacis que pode alegrar sua vidis. Atirei o pau no gatis, per gatis num morreus. Detraxit consequat et quo num tendi nada. Mais vale um bebadis conhecidiss, que um alcoolatra anonimis.</p>
    </div>
</div>

<div style="text-align: center; margin-top: 30px">
    <div  style="display: inline;" class="anima_left">
      <?php
